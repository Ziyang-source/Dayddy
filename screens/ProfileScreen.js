...
export default function ProfileScreen({ navigation }) {
  ...
  return (
    <View style={styles.screen}>
      <StatusBar backgroundColor="#fffbff" barStyle="dark-content" />
      ...
      {/* 添加 BottomNavBar */}
      <BottomNavBar activeRoute="Profile" navigation={navigation} />
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  container: {
    ...
    paddingBottom: 110, // 增加底部边距，防止被 BottomNavBar 遮挡 (高度85 + 额外间距)
    flexGrow: 1,
  },
  // 保持原有 styles 不变...
  profileCard: {
