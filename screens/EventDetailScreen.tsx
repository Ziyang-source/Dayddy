...
const styles = StyleSheet.create({
  ...
  header: {flexDirection:'row', alignItems:'center', justifyContent:'space-between', paddingHorizontal:16, height:70, backgroundColor:'#fff', borderBottomLeftRadius:Radius.xl, borderBottomRightRadius:Radius.xl, zIndex:5, ...Shadow.medium},
  backBtn: {width:56, height:56, alignItems:'center', justifyContent:'center'},
  headerTitle: {fontSize:20, fontFamily: FontFamily.headlineBold, color: '#7e5b64'},
  content: {paddingHorizontal:24, paddingTop:20, paddingBottom:36, gap:18},
  badgeRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
  ...
  title: {fontSize:34, lineHeight:38, fontFamily: FontFamily.headlineBold, color: Colors.onSurface},
  dateCard: {
    borderRadius: 26,
  ...
  infoValue: {fontSize:16, fontFamily: FontFamily.bodyBold, color: Colors.onSurface},
  notesCard: {
    backgroundColor:'#f8f6c3',
    borderRadius:28,
    padding:18,
  ...
  notesTitle: {fontSize:18, fontFamily: FontFamily.headlineBold, color: Colors.primary},
  notesText: {fontSize:15, lineHeight:24, fontFamily: FontFamily.bodyMedium, color: Colors.onSurface},
  rowButtons: {flexDirection:'row', gap:14, marginTop:4},
  editBtn: {
    flex:1,
    height:62,
    borderRadius:24,
  ...
  editText: {fontFamily: FontFamily.bodyBold, fontSize:16, color:'#666643'},
  deleteBtn: {
    flex:1,
    height:62,
    borderRadius:24,
  ...
  deleteText: {fontFamily: FontFamily.bodyBold, fontSize:16, color:'#c12048'},
});
