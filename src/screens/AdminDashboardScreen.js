...
export default function AdminDashboardScreen({ navigation }) {
  ...
  const handleLogout = async () => {
    Alert.alert('Logout', 'Are you sure you want to logout?', [
      ...
      { text: 'Logout', style: 'destructive', onPress: async () => { await AsyncStorage.clear(); navigation.replace('Splash'); } },
    ]);
  };
  ...
  const refreshDashboard = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Network Notice',
        'Could not fetch cloud data. Showing latest local values.',
      );
    } finally {
      setIsLoading(false);
      ...
      >
        ...
        <View style={styles.teamCard}>
          <View style={styles.teamRow}>
            <Text style={styles.userIcon}>ðŸŸ£</Text>
            <View style={styles.teamTextWrap}>
              <Text style={styles.teamTitle}>Noor Jihan</Text>
              <Text style={styles.teamSub}>Manager â€¢ Online now</Text>
            </View>
          </View>
          <View style={styles.teamRow}>
            <Text style={styles.userIcon}>ðŸŸ¡</Text>
            <View style={styles.teamTextWrap}>
              ...
              <Text style={styles.teamSub}>Admin â€¢ 12 tasks done</Text>
            </View>
          </View>
        </View>
        ...
        {isLoading ? (
          ...
          <Text style={styles.footerNote}>
            Tip: Pull down to refresh cloud metrics.
          </Text>
        )}
      </ScrollView>
    </SafeAreaView>
