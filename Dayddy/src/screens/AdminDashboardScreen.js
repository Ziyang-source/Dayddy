...
export default function AdminDashboardScreen({ navigation }) {
  ...
  const summaryCards = useMemo(
    () => [
      { label: 'TOTAL USERS', value: stats.users.toLocaleString(), tag: '100%' },
      { label: 'TOTAL EVENTS', value: stats.events.toLocaleString(), tag: '100%' },
      { label: 'TOTAL TASKS', value: stats.tasksCompleted.toLocaleString(), tag: `100%` },
    ],
    [stats],
  );
        ...
        { text: 'Cancel', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              ...
              console.log('Logged out to Login page');
            } catch (error) {
    ...
    <SafeAreaView style={styles.screen}>
      ...
      >
        <View style={styles.topBar}>
          <Text style={styles.appTitle}>Dayddy</Text>
          <Text style={styles.smallIcon}>⚙</Text>
        </View>

        <View style={styles.heroCard}>
          <Text style={styles.welcomeTitle}>Welcome Back,</Text>
          <Text style={styles.welcomeTitle}>Admin</Text>
